...
class _HomeApiClient implements HomeApiClient {
  ...
  @override
  Future<HttpResponse<dynamic>> getCoins() async {
  ...
  @override
  Future<HttpResponse<dynamic>> getGraphData(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/v3/coins/${id}/market_chart?vs_currency=usd&days=1&day=1',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
